"""
Django settings for projectmyss project.
...
SECRET_KEY = 'django-insecure-j^$*%z4y+b2#$bku#lo@*!t=c%^wi0m3egc)y*@&fik17d^^8e'
    ...
    'default': {
        ...
        'OPTIONS': {
            ...
            'CONNECTION_POOL_KWARGS': {
                'ssl_cert_reqs': None  # Deshabilitar verificación de certificados SSL
            }
        }
    }
}
...
WSGI_APPLICATION = 'projectmyss.wsgi.application'
